#ifndef BGFX_ATARI_8_H
#define BGFX_ATARI_8_H

#include <stdint.h>

#define BGFX_ATARI_8_WIDTH (int)8               // Font px width
#define BGFX_ATARI_8_HEIGHT (int)16             // Font px height

static const uint8_t BGFX_ATARI_8_FONT[] = {
...
source-name: system10.fnt
source-format: gdos
source-url: https://github.com/th-otto/gemfedit/tree/master/fonts/tos
gdos: font-id=1 left-offset=1 right-offset=7
shift-up: -2
